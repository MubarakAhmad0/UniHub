...
const courses = [
  ...
  },
  {
    ...
    professor: "Professor Mark Sterling",
    credits: 3,
    weightedGrade: 91.0,
    status: "normal" as const,
    components: [
      {
        ...
        items: [
          {
            name: "Essay 1: Florentine Schools",
            score: 88,
            total: 100,
            status: "Graded" as AssignmentStatus,
          },
          {
            name: "Essay 2: Northern Renaissance",
            score: 94,
            total: 100,
            status: "Graded" as AssignmentStatus,
          },
...
const statusItemVariant: Record<
  AssignmentStatus,
                              ...
                              {comp.items.map((item) => (
                                ...
                                >
                                  ...
                                  <TableCell className="py-2 text-right pr-0">
                                    <Badge
                                      variant={statusItemVariant[item.status]}
                                      className="text-xs"
                                    >
                                      {item.status}
                                    </Badge>
          ...
          <div className="space-y-4">
            <Card className="shadow-sm border-0 bg-card">
              ...
              <CardContent className="px-5 pb-5 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Projected final GPA for this semester based on your current
                  trajectory. You are exceeding your personal target by{" "}
            ...
            <Card className="shadow-sm border-0 bg-card">
              ...
              <CardContent className="px-5 pb-5 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Maintain a GPA above{" "}
                  <span className="font-medium text-foreground">3.5</span> to
                  qualify for the{" "}
                  <span className="font-medium text-foreground">
                    Honors Scholar
                  </span>{" "}
            ...
            <Card className="shadow-sm border-0 bg-destructive/10">
              ...
              <CardContent className="px-5 pb-5">
                <p className="text-sm text-muted-foreground">
                  ...
                  the final exam is required to achieve a passing grade.
                </p>
              </CardContent>
            </Card>
          </div>
